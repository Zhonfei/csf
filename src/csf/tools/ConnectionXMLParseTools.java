 ...
 * @author delta
 */
public class ConnectionXMLParseTools {
    public static String PATH = "G:\\personalWorkPlace\\huoxingAPP\\csf\\WebContent\\config\\ConnectBeans.xml";
	//public static String PATH = Tools.getBasePath()+"\\csf\\WebContent\\config\\ConnectBeans.xml";
